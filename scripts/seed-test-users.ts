...
/**
 * Test User Seed Script (TypeScript Version)
 * 
 * Generates SQL INSERT statements for test users with various subscription tiers.
 * 
 * Usage:
 *   npx ts-node scripts/seed-test-users.ts              # Print to console
 *   npx ts-node scripts/seed-test-users.ts > seed-data.sql  # Save to file
 */
